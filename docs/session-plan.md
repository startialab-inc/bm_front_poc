...
| 26 | 308:6387 | logo | ✅ | ✅ AppLogo.vue（A-18）|
| 27 | 411:7357 | Icon/LeftMenu | ✅ | ✅ AppLeftMenuIcon.vue（A-19）|
| 28 | 520:12941 | Contact | ✅ | ✅ AppContact.vue（A-20）|
| 29 | 2051:66855 | Snackbar | ✅ | ✅ AppSnackbar.vue（A-21）|
| 30 | 3790:101917 | Button/Secondary-cancel | ✅ | → AppButton.vue（variant=secondary + iconLeft=xmark） |
| 31 | 3790:101927 | Button/Secondary-close | ✅ | → AppButton.vue（variant=secondary + iconLeft=xmark） |
| 32 | 3801:103145 | Button/Secondary-other | ✅ | → AppButton.vue（variant=secondary + iconRight=angle-down） |
...
| 29 | 520:13298 | SegmentControl | ✅ | ✅ AppSegmentControl.vue（M-4）|
| 30 | 849:2467 | Tab | ✅ | ✅ AppTab.vue（M-5）|
| 31 | 932:25039 | Pagination | ✅ | ✅ AppPagination.vue（M-6）|
| 32 | 801:16732 | FormHeading | ✅ | ✅ AppFormHeading.vue（M-32）|
| 33 | 801:16744 | FormTitle | ✅ | ✅ AppFormTitle.vue（M-33）|
| 34 | 806:17001 | ConfirmSection | ✅ | ✅ AppConfirmSection.vu2e |
| 35 | 849:3283 | Calendar+Time | ✅ | ⏸️ ペンディング（カレンダーライブラリ未確定） |
| 36 | 621:12561 | PageSettingStatus | ✅ | ✅ AppPageSettingStatus.vue |
| 37 | 932:24445 | FavoriteBlock | ✅ | ✅ AppFavoriteBlock.vue |
| 38 | 643:13340 | BlockEditMenuCell | ✅ | ✅ AppBlockEditMenuCell.vue |
...
| 44 | 797:9870 | BlockEditMenu | ✅ | ✅ AppBlockEditMenu.vue |
| 45 | 871:50191 | ModalFooter | ✅ | ✅ AppModalFooter.vue |
| — | 2051:66897 | ImageSelector → **AppImageSelector.vue** (M-7) | ✅ | ✅ |
| — | 1793:71658 | ContactItemType → **AppContactItemType.vue** (M-8) | ✅ | ✅ |
| — | 2051:67078 | ContactItemTypeSelectMenu → **AppContactItemTypeSelectMenu.vue** (M-9) | ✅ | —（`<select>` で代替、実装スキップ） |
...
| 46 | 308:6191 | sidebar | ✅ | ⬜ |
| 47 | 520:6480 | Header | ✅ | ⬜ |
| 48 | 643:13397 | AddBlockMenu ※「Title」という単独Organismは存在しなかった。このnode-idの実体はAddBlockMenu（ブロック追加パネル） | ✅ | ⬜ |
| 49 | 520:11934 | Title/Pages（1384×72px） | ✅ | ⬜ |
| 49b | 3745:40934 | Title/Pages（別バージョン・1200×56px）※調査で新発見 | ✅ | ⬜ |
...
| 56 | 621:13699 | TableHeaderRight/Pages | ✅ | ⬜ |
| 57 | 621:15300 | TableHeaderRight/GlobalParts | ✅ | ⬜ |
| 58 | 625:7951 | TableHeaderRight/Article | ✅ | ⬜ |
| 59 | 871:32032 | TableHeaderRight/Cagetgory（Figma typo; 正: Category） | ✅ | ⬜ |
| 60 | 938:47678 | TableHeaderRight/Trash（1つ目） | ✅ | ⬜ |
| 61 | 959:47527 | TableHeaderRight/FIle（Figma typo; 正: File） | ✅ | ⬜ |
| 62 | 970:82954 | TableHeaderRight/News | ✅ | ⬜ |
| 63 | 1176:56723 | TableHeaderRight/User | ✅ | ⬜ |
| 64 | 1342:61896 | TableHeaderRight/Trash（2つ目） | ✅ | ⬜ |
| — | 1935:68135 | TableHeaderRight/CurationMedia | ✅ | ⬜ |
| — | 1937:72567 | TableHeaderRight/CurationList | ✅ | ⬜ |
| 65 | 621:13867 | TableRowLeft/Pages | ✅ | ⬜ |
| 66 | 625:7929 | TableRowLeft/Article | ✅ | ⬜ |
| 67 | 621:16443 | TableRowLeft/GlobalParts | ✅ | ⬜ |
| 68 | 871:32495 | TableRowLeft/Category | ✅ | ⬜ |
| 69 | 938:47680 | TableRowLeft/Trash（1つ目） | ✅ | ⬜ |
| 70 | 1342:61897 | TableRowLeft/Trash（2つ目） | ✅ | ⬜ |
| 71 | 959:47526 | TableRowLeft/File | ✅ | ⬜ |
| 72 | 970:82955 | TableRowLeft/News | ✅ | ⬜ |
| — | 1000:52557 | TableRowLeft/User | ✅ | ⬜ |
| — | 1935:68134 | TableRowLeft/CurationMedia | ✅ | ⬜ |
| — | 1937:72566 | TableRowLeft/CurationList | ✅ | ⬜ |
| 73 | 621:14049 | TableRowRight/Pages | ✅ | ⬜ |
| 74 | 621:15264 | TableRowRight/GlobalParts | ✅ | ⬜ |
| 75 | 625:7930 | TableRowRight/Article | ✅ | ⬜ |
| 76 | 871:32033 | TableRowRight/Category | ✅ | ⬜ |
| 77 | 938:47679 | TableRowRight/Trash（1つ目） | ✅ | ⬜ |
| 78 | 959:47528 | TableRowRight/FIle（Figma typo; 正: File） | ✅ | ⬜ |
| 79 | 970:82953 | TableRowRight/News | ✅ | ⬜ |
| 80 | 1000:52559 | TableRowRight/User | ✅ | ⬜ |
| — | 1935:68136 | TableRowRight/CurationMedia | ✅ | ⬜ |
| — | 1937:72568 | TableRowRight/CurationList | ✅ | ⬜ |
| — | 1342:61895 | TableRowRight/Trash（2つ目・7列版） | ✅ | ⬜ |
| 82 | 621:17133 | InlineMenu/Pages | ✅ | ⬜ |
| 83 | 621:17401 | InlineMenu/Article | ✅ | ⬜ |
| 84 | 621:17635 | InlineMenu/Curation | ✅ | ⬜ |
| 85 | 643:13491 | InlineMenu/PageEditor | ✅ | ⬜ |
| 86 | 621:17463 | InlineMenu/News | ✅ | ⬜ |
| 87 | 621:17510 | InlineMenu/File | ✅ | ⬜ |
| 88 | 621:17553 | InlineMenu/Item | ✅ | ⬜ |
| 89 | 1342:62176 | InlineMenu/Trash | ✅ | ⬜ |
| 90 | 621:17576 | InlineMenu/User | ✅ | ⬜ |
| 91 | 849:6270 | Table/UserDirectory | ✅ | ⬜ |
| 92 | 849:6271 | Table/UserDirectoryFile | ✅ | ⬜ |
| 93 | 854:2658 | Table/User | ✅ | ⬜ |
| 94 | 3225:6670 | Table/flow | ✅ | ⬜ |
| 95 | 889:42970 | ChangeHistoryTableHeader | ⬜ | ⬜ |
| 96 | 889:42969 | ChangeHistoryTableRow | ⬜ | ⬜ |
| 97 | 955:48641 | FileUploadTableHeader | ⬜ | ⬜ |
| 98 | 955:48642 | FileUploadTableRow | ⬜ | ⬜ |
...
| — | 643:13549 | BlockHover（ブロックホバーオーバーレイ） | ✅ | ⬜ |
| — | 643:13612 | BlockSelect（ブロック選択状態コンポジット） | ✅ | ⬜ |
| — | 643:13368 | AddBlockMenuCell（ブロック追加メニューセル） | ✅ | ⬜ |
| — | 643:13548 | BlockMoveCell（上下移動ボタン） | ✅ | ⬜ |
| — | 643:13608 | Badge/SelectBlock（ブロック選択中バッジ） | ✅ | ⬜ |
| — | 1173:25606 | BlockSelectFooter（ブロック選択フッターバー） | ✅ | ⬜ |
| — | 855:18985 | PagesLayer（ページ階層ツリー行、7段階） | ✅ | ⬜ |
| — | 1132:87972 | ArticleIndex（記事目次パネル） | ✅ | ⬜ |
| — | 687:18570 | DownloadBlockIndex（ダウンロードブロックカテゴリボタン） | ✅ | ⬜ |
| — | 702:18792 | DownloadBlockCell（ダウンロードブロックセル） | ✅ | ⬜ |

### Templates

| # | node-id | パーツ名 | Phase C | Phase D |
|---|---------|----------|---------|---------|
| 99 | 855:20693 | ModalLayer | ⬜ | ⬜ |
| 100 | 938:52200 | ArticleEditor | ⬜ | ⬜ |
| 101 | 967:72034 | Dashboard/Top | ⬜ | ⬜ |
| 102 | 960:55557 | Dashboard/SummaryValue | ⬜ | ⬜ |
| 103 | 960:55834 | Dashboard/Graph | ⬜ | ⬜ |
| 104 | 970:72836 | Dashboard/Case | ⬜ | ⬜ |
| 105 | 970:72979 | Dashboard/LevelUp | ⬜ | ⬜ |
| 106 | 967:72204 | Dashboard/News | ⬜ | ⬜ |
| 107 | 967:72354 | Dashboard/Study | ⬜ | ⬜ |
| — | 2319:5852 | login（ログインフォームカード） | ✅ | ⬜ |
| — | 2319:5853 | login-news（ログイン画面お知らせパネル） | ✅ | ⬜ |
| — | 2358:78770 | export（エクスポートセクション） | ✅ | ⬜ |
| — | 2358:78801 | import（インポートセクション） | ✅ | ⬜ |
| — | 3738:5856〜5976 | PreviewBar（全幅インジケーター・6バリアント統合） | ✅ | ⬜ |
...
| `AppContact.vue` | #28 Contact | props なし。青い円（#2862cb）+ contact.svg（吹き出しのみ）。✅ 実装済み |
...
| `AppContact.vue` | #28 Contact | ✅ 実装済み。contact.svg（吹き出しアイコンのみ）を公開アセットとして配置し、CSS で青い円背景（#2862cb）を付与 |

FontAwesome（CDN）では補えないカスタムアイコンフォントを fantasticon で生成する（AppContact は不要・実装済み）。
...
| A-18 | `AppLogo.vue` | 308:6387 | ✅ |
| A-19 | `AppLeftMenuIcon.vue` | 411:7357 | ✅ |
| A-20 | `AppContact.vue` | 520:12941 | ✅（2026-05-22） |
| A-21 | `AppSnackbar.vue` | 2051:66855 | ✅ |
| A-22 | `BaseControlLabel.vue` | （新設） | ✅ |

### Molecules Phase D（Atoms 完了後）

| # | Vue コンポーネント | 対応 Figma node-id | Phase D |
|---|---|---|---|
| M-1 | `AppRadioButton.vue` | 917:52673, 917:53007 | ✅ |
| M-2 | `AppCheckbox.vue` | 917:53263 | ✅ |
| M-3 | `AppSwitchLabel.vue` | （新設） | ✅ |
| M-4 | `AppSidebarMenuItem.vue` | 308:6380（#25）, 308:6450（#39） | ✅ |
| M-5 | `AppSidebarSubMenu.vue` | 308:6469（#40）, 520:6437（#41） | ✅ |
| M-6 | `AppSidebarSubMenuItem.vue` | 417:8671（#42） | ✅ |
| M-7 | `AppImageSelector.vue` | 2051:66897 | ✅ |
| M-8 | `AppContactItemType.vue` | 1793:71658 | ✅ |
| M-9 | `AppContactItemTypeSelectMenu.vue` | 2051:67078 | —（`<select>` で代替、実装スキップ） |

### Organisms Phase D（テスト実装の評価結果により着手判断）

> **⚠️ 方針変更（2026-06-11）**: プロジェクトチームからの要請により、Organisms を個別コンポーネントとして実装する前に、まず単体ページを直接実装するテストを行う。テスト実装の評価結果（実装スピード・保守性・Figma 再現精度）が良好であれば引き続きページ実装を進め、思わしくなければ下表の Organisms を先に実装する。

| # | Vue コンポーネント | 対応 Figma node-id | Phase D |
|---|---|---|---|
| O-1 | `AppSidebar.vue` | 308:6191（#46） | ⬜（テスト実装の評価後に判断） |
| O-2 | `AppContactItemCell.vue` | 1793:71220 | ⬜（テスト実装の評価後に判断） |
| O-3 | `AppContactItemAdd.vue` | 1793:71219 | ⬜ |
| O-4 | `AppContactItemErrorModal.vue` | 1793:74592 | ⬜ |

### テスト実装フェーズ

- **目的**: Organisms コンポーネント未実装の状態で単体ページを直接実装できるか検証する
- **判断基準**: 実装スピード・コードの保守性・Figma 再現精度
- **前提**: Organisms Phase C の残り全件収集を先に完了させる
- **成功時**: ページ実装を継続する
- **不成功時**: Organisms をコンポーネントとして順次実装し直す（O-1 AppSidebar から）

---

最終更新: 2026-06-11（方針変更：Organisms を先に実装せずテスト実装（単体ページ直接実装）を先行。Organisms Phase C の残り全件収集が最初のステップ。CalendarTime・ScrollArea はペンディング継続。）
...
| A-18 | `AppLogo.vue` | 3バリアント（landscape/portrait/square）。props は全て小文字。`src` と `dim` は `computed()` でラップ（非 computed だと variant 変更時に再レンダリングされない）。アセット: `public/assets/images/logo/logo-{variant}.svg` |
| A-19 | `AppLeftMenuIcon.vue` | `status: 'close' \| 'open'`（デフォルト close）。emit: toggle（制御コンポーネント）。40×40px ボタン + 16×16px アイコン。CSS mask-image + bg-current 手法でホバー時アイコン色を text-text-brand に変化（SVG は固定色のため `<img>` では color が効かない）。JSDOM では mask-image が style 属性に反映されないため、テストは aria-label の切り替えで状態を間接確認。 |
